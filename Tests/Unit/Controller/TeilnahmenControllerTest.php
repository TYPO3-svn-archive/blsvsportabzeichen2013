...
/**
 * Test case for class Tx_Blsvsa2013_Controller_TeilnahmenController.
 *
 * @version $Id$
 ...
 */
class Tx_Blsvsa2013_Controller_TeilnahmenControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
