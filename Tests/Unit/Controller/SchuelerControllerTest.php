...
/**
 * Test case for class Tx_Blsvsa2013_Controller_SchuelerController.
 *
 * @version $Id$
 ...
 */
class Tx_Blsvsa2013_Controller_SchuelerControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
