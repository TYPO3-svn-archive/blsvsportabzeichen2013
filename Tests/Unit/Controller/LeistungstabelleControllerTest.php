...
/**
 * Test case for class Tx_Blsvsa2013_Controller_LeistungstabelleController.
 *
 * @version $Id$
 ...
 */
class Tx_Blsvsa2013_Controller_LeistungstabelleControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
