...
/**
 * Test case for class Tx_Blsvsa2013_Controller_SchulenController.
 *
 * @version $Id$
 ...
 */
class Tx_Blsvsa2013_Controller_SchulenControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
