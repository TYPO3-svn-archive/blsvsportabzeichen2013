...
/**
 * Test case for class Tx_Blsvsa2013_Controller_SportartenController.
 *
 * @version $Id$
 ...
 */
class Tx_Blsvsa2013_Controller_SportartenControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
