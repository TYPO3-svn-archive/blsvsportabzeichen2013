...
/**
 * Test case for class Tx_Blsvsa2013_Controller_KlassenController.
 *
 * @version $Id$
 ...
 */
class Tx_Blsvsa2013_Controller_KlassenControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
