...
/**
 * Test case for class Tx_Blsvsa2013_Controller_BestellungController.
 *
 * @version $Id$
 ...
 */
class Tx_Blsvsa2013_Controller_BestellungControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
