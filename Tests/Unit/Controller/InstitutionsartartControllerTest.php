...
/**
 * Test case for class Tx_Blsvsa2013_Controller_InstitutionsartartController.
 *
 * @version $Id$
 ...
 */
class Tx_Blsvsa2013_Controller_InstitutionsartartControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
